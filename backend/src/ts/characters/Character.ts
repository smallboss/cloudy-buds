...
import { KeyBinding } from '../core/KeyBinding.ts';
import { VectorSpringSimulator } from '../physics/spring_simulation/VectorSpringSimulator.ts';
import { RelativeSpringSimulator } from '../physics/spring_simulation/RelativeSpringSimulator.ts';
import { Idle } from './character_states/Idle.ts';
// import { ICharacterAI } from '../interfaces/ICharacterAI.ts';
import { World } from '../world/World.ts';
import { IControllable } from '../interfaces/IControllable.ts';
import { ICharacterState } from '../interfaces/ICharacterState.ts';
import { IWorldEntity } from '../interfaces/IWorldEntity.ts';
import { CollisionGroups } from '../enums/CollisionGroups.ts';
import { CapsuleCollider } from '../physics/colliders/CapsuleCollider.ts';
// import { VehicleEntryInstance } from './VehicleEntryInstance';
import { SeatType } from '../enums/SeatType';
import { GroundImpactData } from './GroundImpactData.ts';
import { ClosestObjectFinder } from '../core/ClosestObjectFinder';
import { Object3D } from 'three';
import { EntityType } from '../enums/EntityType.ts';
// import { DropRolling } from './character_states/DropRolling.ts';
...
export class Character extends THREE.Object3D implements IWorldEntity
{
	...
	constructor(gltf: any, scenario?: Scenario)
	{
		...
		// this.modelContainer.scale.setScalar(0.01);
